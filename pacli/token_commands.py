...
def all_balances(address: str=Settings.key.address, wallet: bool=False, keyring: bool=False, no_labels: bool=False, only_tokens: bool=False, advanced: bool=False, named: bool=False, only_labels: bool=False, deck_type: int=None, quiet: bool=False, empty: bool=False, debug: bool=False):
    ...
    if wallet and not no_labels:
        labeldict = ec.get_labels_and_addresses(keyring=keyring, named=named, empty=empty)
